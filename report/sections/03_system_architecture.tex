...
Sistemin genel mimarisi Sekil~\ref{fig:architecture-placeholder}'de ozetlenen veri akisina dayanmaktadir:
...
{Projenin genel sistem mimarisi.}
{fig:architecture-placeholder}
